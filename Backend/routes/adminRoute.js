...
const {getAllService,getAllUser,getCategoryService,getUserById,getUserService,getServiceById,getBlockedUser,isBlockService,isBlockUser,getBlockService,}=require('../controller/admin')
